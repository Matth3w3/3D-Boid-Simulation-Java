...
class Vec3 {
    ...
    // SUBTRACTION (-) //
    public void sub(double x, double y, double z) { this.x -= x; this.y -= y; this.z -= z; }
    public void sub(double n) { this.sub(n, n, n); }
    public void sub(Vec3 v) { this.sub(v.x, v.y, v.z); }

    // MULTIPLICATION (*) //
    public void mult(double x, double y, double z) { this.x *= x; this.y *= y; this.z *= z; }
    ...
    // DOT PRODUCT //
    public double dot(Vec3 v) { return (this.x * v.x) + (this.y * v.y) + (this.z * v.z); }
